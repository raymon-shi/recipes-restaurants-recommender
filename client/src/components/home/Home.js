...
const Home = () => {
  ...
  const [restaurantRecipeName, setRestaurantRecipeName] = useState('');
        ...
        <Tab eventKey='recipes' title='Recipes Recommender'>
          <Form onSubmit={(e) => e.preventDefault()}>
            ...
            <Button
              ...
              onClick={() => navigate(`/searchRecipe/${recipeRestaurantName}/${recipeRating}/${recipePrepTime}`)}>
        ...
        <Tab eventKey='restaurants' title='Restaurants Recommender'>
          <Form onSubmit={(e) => e.preventDefault()}>
            ...
            <Button
              ...
              onClick={() => navigate(`/searchRestaurant/${restaurantRecipeName}/${restaurantRating}/${restaurantReviewCount}`)}>
